...
tr14 = zeros(N_samples,25);
tr15 = zeros(N_samples,25);
...
try14 = ones(N_samples,1)*13;
try15 = ones(N_samples,1)*14;
...
train_y=[try1(1:n_tr,:);try2(1:n_tr,:);try3(1:n_tr,:);try4(1:n_tr,:);try5(1:n_tr,:)...
    ...
    ;try11(1:n_tr,:);try12(1:n_tr,:);try13(1:n_tr,:);try14(1:n_tr,:);try15(1:n_tr,:)];
...
for snr = snr_min:snr_max
    ...
    trx14 = mode14((snr-snr_min)*N_samples+1:(snr-snr_min)*N_samples+N_samples,:);
    trx15 = mode15((snr-snr_min)*N_samples+1:(snr-snr_min)*N_samples+N_samples,:);
    ...
    ;trx11(1:n_tr,:);trx12(1:n_tr,:);trx13(1:n_tr,:),;trx14(1:n_tr,:);trx15(1:n_tr,:)];
    ...
    ;trx12(N_samples-n_te+1:N_samples,:);trx13(N_samples-n_te+1:N_samples,:);trx14(N_samples-n_te+1:N_samples,:)...
    ;trx15(N_samples-n_te+1:N_samples,:)];
