...
%ylim([0.98,1])
xlim([-4,20])
h6=legend('\fontname{Times New Roman}\it{SNR\rm_{tr} = 20 dB}', '\fontname{Times New Roman}\it{SNR\rm_{tr} = 16 dB}', ...
    '\fontname{Times New Roman}\it{SNR\rm_{tr} = 12 dB}', '\fontname{Times New Roman}\it{SNR\rm_{tr} = 8 dB}',...
    '\fontname{Times New Roman}\it{SNR\rm_{tr} = 4 dB}', '\fontname{Times New Roman}\it{SNR\rm_{tr} = 0 dB}');
