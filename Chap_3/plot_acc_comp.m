...
load acc_fs_24  %特征提取
acc_fs = ace_m;
load acc_sae_88 %SAE 0-20 样本不够
acc_sae_88 = test_acc;
load acc_sae_160%SAE 10 样本足够
...
l1 = legend('FS-AMR, \itSNR\rm_{tr}=10 dB, \itN\rm_s=24','MLP, \itSNR\rm_{tr}\in[0 20] dB \itN\rm_s=88',...
    'MLP, \itSNR\rm_{tr}=10 dB, \itN\rm_s=160', 'MLP, \itSNR\rm_{tr}\in[0 20] dB, \itN\rm_s=176',...
    'CNN, \itSNR\rm_{tr}\in[0 20] dB \itN\rm_s=200','CNN, \itSNR\rm_{tr}=10 dB, \itN\rm_s=300',...
    'CNN, \itSNR\rm_{tr}\in[0 20] dB, \itN\rm_s=300','Fontsize',10.5,'FontName','Times New Roman');
